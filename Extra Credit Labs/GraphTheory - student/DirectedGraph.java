...
public class DirectedGraph 
{
    ...
    public void addEdges(Set<Edge> edges)
    {
        ...
        while (it.hasNext() && !edges.isEmpty())
        {
            Edge e = (Edge)it.next();
            if (myVertices.contains(e.getA()) && myVertices.contains(e.getB()) && !myEdges.contains(e))
            {
                myEdges.add(e);
            }
        }
    ...
    public boolean isAdjacent(String s, String t)
    {
        ...
        while (it.hasNext() && !myEdges.isEmpty())
        {
            Edge e = (Edge)it.next();
            if ((e.getA()==s && e.getB()==t) || (e.getA()==t && e.getB()==s))
            {
                return true;
            }
        }
